...
def main(status_pause=False,index=0,last_file=None):
    ...
    if last_file!=None :#status_pause=True
        ...
        print('last_file_draw',image_paths[index])
        image_read =cv2.imread(image_paths[index])
    else:
    ...
    return status_pause,ii,image_path
